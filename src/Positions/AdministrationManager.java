...
public class AdministrationManager extends SalariedPerson implements ITitle {
    private final String POSITION_TITLE = "AdministrationManager";
    ...
    public AdministrationManager(String fName,String sName,String dob,PayCycle paymentCycle,
