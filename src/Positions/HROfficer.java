...
public class HROfficer extends SalariedPerson implements ITitle {
    private final String POSITION_TITLE = "HR Officer";
    private final double BASED_SALARY = 50000.0;
    private final String MANAGER_NAME = "James Mint";
    PersonOperations ops = new PersonOperations();
    Manager manager = new Manager();
    
    public HROfficer(String fName,String sName,String dob,PayCycle paymentCycle,
