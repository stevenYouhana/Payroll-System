...
public class ProgramDeveloper extends SalariedPerson implements ITitle{
    private final String POSITION_TITLE = "Program Developer";
    private final double BASED_SALARY = 70000.0;
    private final String MANAGER_NAME = "Ashley Simpson";
    PersonOperations ops = new PersonOperations();
    Manager manager = new Manager();
    
    public ProgramDeveloper(String fName,String sName,String dob,PayCycle paymentCycle,
