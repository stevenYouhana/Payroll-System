...
public class BranchManager extends SalariedPerson implements ITitle{
private final String POSITION_TITLE = "Branch Manager";
    private final double BASED_SALARY = 90000.0;
    private final String MANAGER_NAME = "Bill Johns";
    PersonOperations ops = new PersonOperations();
    Manager manager = new Manager();
    
    public BranchManager(String fName,String sName,String dob,PayCycle paymentCycle,
