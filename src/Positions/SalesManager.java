...
public class SalesManager extends SalariedPerson implements ITitle {
    private final String POSITION_TITLE = "Sales Manager";
    ...
    public SalesManager(String fName,String sName,String dob,PayCycle paymentCycle,
